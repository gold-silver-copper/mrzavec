...
/// Numeral government for a counted phrase in a syntactic slot. The crate
/// owns the government rules end to end (interslavic 0.13.0): the noun
/// form AND the agreement decision both come from `quantified_parts`, so
/// adjectives can never desynchronize from nouns.
